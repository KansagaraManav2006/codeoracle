...
export const TabNavigation: React.FC<TabNavigationProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <div className="sticky top-[61px] z-40 -mx-3 mb-4 flex overflow-x-auto border-b border-slate-800 bg-slate-900/95 px-2 shadow-sm backdrop-blur sm:top-[65px] sm:mx-0 sm:mb-6 sm:space-x-1 sm:px-0 lg:top-[77px]">
      {tabs.map((tab) => {
        const Icon = tab.icon;
        ...
        return (
          <button
            ...
            className={`flex shrink-0 items-center gap-1.5 px-3 py-3 text-xs font-medium border-b-2 transition-all sm:gap-2 sm:px-4 sm:text-sm lg:px-5 ${
              isActive
