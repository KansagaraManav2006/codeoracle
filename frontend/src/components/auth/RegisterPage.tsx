  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-[#F5F1E9] text-[#181715]">
      ...
      <div className="hidden lg:block lg:w-[55%] min-h-screen sticky top-0 h-screen">
        <AuthVisualPanel
          headline="Turn unfamiliar code into a clear next step."
          subheadline="Explore dependencies, understand behavior, and review proposed improvements."
          activeMode="register"
        />
      </div>
      ...
      <div className="lg:hidden bg-[#181715] text-[#FFFDFC] p-6 pb-8 border-b border-[#3B3733]">
        ...
        <h2 className="font-display text-xl font-bold text-[#FFFDFC] mb-1">
          Turn unfamiliar code into a clear next step.
        </h2>
        <p className="text-xs text-[#C8BEB0]">
          Explore dependencies, understand behavior, and review proposed improvements.
        </p>
      </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                aria-describedby={localErrors.email ? 'register-email-error' : undefined}
              />
              {localErrors.email && (
                <p id="register-email-error" className="text-xs text-[#D9383A] mt-1 font-medium">
                  {localErrors.email}
                </p>
              )}
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <span className="text-[11px] text-[#5C554D]">Minimum 8 characters</span>
              </div>
              <div className="relative">
                <input
                  ...
                  aria-describedby={localErrors.password ? 'register-password-error' : undefined}
                />
                <button
                  type="button"
              ...
              {localErrors.password && (
                <p id="register-password-error" className="text-xs text-[#D9383A] mt-1 font-medium">
                  {localErrors.password}
                </p>
              )}
            </div>
