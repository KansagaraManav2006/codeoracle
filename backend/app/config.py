...
class Settings(BaseSettings):
    ...
    MAX_ZIP_COMPRESSED_BYTES: int = 25 * 1024 * 1024  # 25MB
    MAX_ZIP_UNCOMPRESSED_BYTES: int = 100 * 1024 * 1024  # 100MB
    MAX_FILE_BYTES: int = 10 * 1024 * 1024  # 10MB
    MAX_ZIP_ENTRIES: int = 1000
    MAX_COMPRESSION_RATIO: float = 100.0
    MAX_RELEVANT_LINES: int = 10000
    CLONE_TIMEOUT_SECONDS: int = 30
    MAX_CLONE_SIZE_BYTES: int = 100 * 1024 * 1024  # 100MB
